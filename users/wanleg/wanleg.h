...
#define _______________GherkinLike_2_______________     TD(TD_SFT_CAPS), SFT_T(KC_Z), 	KC_X, 	KC_C, 	KC_V,	KC_B,  KC_N, 	KC_M, 	KC_COMM,	ALT_T(KC_DOT),	CTL_T(KC_BSPC), SFT_T(KC_ENT)
