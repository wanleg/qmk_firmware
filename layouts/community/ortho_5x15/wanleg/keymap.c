...
[_GK] = LAYOUT_75_base_wrapper(
  ...
  KC_LCTL, GHERKIN50, KC_LALT, NUMPAD, NUMBER, ETCETERA, LT(_FN,KC_SPC),DIRECTION, KC_RGUI, KC_RALT, KC_DEL, KC_RCTL, KC_0, KC_0, KC_DOT
),
...
[_FN] = LAYOUT_75_base_wrapper(
  ...
  KC_NLCK, _________________BLANK_50__________________, _______, _______, _______, _______
),
#else
[_FN] = LAYOUT_75_base_wrapper(
  RESET,   _______________Gherkin_FN_0________________, _______, _______, _______, _______, 
